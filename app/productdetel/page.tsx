...
// معرض صور عام للمنتج (زوايا مختلفة) - مستقل عن اللون
const galleryImages = [
  "/imgs/WhatsApp Image 2026-05-10 at 9.25.19 PM.jpeg",
  "/imgs/WhatsApp Image 2026-05-10 at 9.25.20 PM (1).jpeg",
  "/imgs/WhatsApp Image 2026-05-10 at 9.25.20 PM (2).jpeg",
  "/imgs/WhatsApp Image 2026-05-10 at 9.25.20 PM (3).jpeg",
 

];

// كل لون له صورة واحدة بس - اختيار اللون بيغير الصورة الرئيسية فقط
const colors = [
  {
    name: "أسود",
    hex: "#1a1410",
...
const product = {
  ...
  originalPrice: 1200,
  description:
    "تيشيرت أوفرسايز مصنوع من قطن مصري 100% بكثافة عالية، مطبوع بنقشة مستوحاة من نقوش الفراعنة. قطعة أساسية تجمع بين الراحة والطابع الفرعوني الأصيل.",
};
...
export default function ProductDetail() {
  ...
  const [selectedSize, setSelectedSize] = useState(sizes[0]); // المقاس الأول مختار افتراضياً
  ...
  // أنيميشن fade كل ما الصورة الرئيسية تتغيّر (من ثَمب نيل أو من اختيار لون)
  useEffect(() => {
    setFade(false);
  ...
  // اختيار اللون يغيّر الصورة الرئيسية فقط - مش مجموعة الصور كلها
  ...
  const handleBuyNow = () => {
    setBuying(true);
    // هنا تحط التنقل لصفحة الشيك أوت
    ...
    <section dir="rtl" className="bg-[#f5f0e8] font-['Cormorant_Garamond',serif]">
      ...
      >
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-4">
          ...
          {/* الصور المصغّرة - معرض عام مستقل عن اللون */}
