...
const products = [
  ...
  },
  {
    ...
    hoverImage: "/imgs/WhatsApp Image 2026-05-10 at 9.25.20 PM (3).jpeg",
    tag: "جديد" as const,
    sizes: ["S", "M", "L"],
    href: "/productdetel",
  },
  ...
  },
  {
    ...
    price: 4200,
    originalPrice: 5500,
    image: "/imgs/WhatsApp Image 2026-05-11 at 10.31.33 PM (1).jpeg",
...
export default function BestSiller() {
  return (
    <section dir="rtl" className="bg-white px-6 md:px-10 py-16 font-[Cairo,sans-serif] " style={{padding:"64px"}}>
      <Reveal>
